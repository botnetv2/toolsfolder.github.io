...
<head>
    ...
    <link rel="icon" type="img/png" sizes="16x16" href="img/red-folder.ico">
	 ...
	 <html lang="en">
      ...
      <meta name="Keywords" content="Tools, ip lookup, stresser, port scanner,psn resolver">
...
<link type="text/css" rel="stylesheet" href="scroll.css">
  ...
  <div class="login-box">
	...
	<a href="/tools.php"><button type="button" class="btn btn-default">BACK TO TOOLS</button></a>
                       <br/><br/>
</head>
<body>
	<form class="form" method="POST">
		<div class="title"><h2><body>
  <p style="color:#FF0000";>Look up IP:</p></body></h2></div>
		<label>IP:</label>
		<div class="formRight"><input type="text" name="lookupip" maxlength="15" /></div>
		<input type="submit" class="btn btn-default" value="Look Up IP" name="lookupipbtn"/>
	</form>
<?php
if (isset($_POST['lookupipbtn'])) {
	...
	if (!filter_var($ip, FILTER_VALIDATE_IP)) {
		die('<center><h2><p style="color:#FF0000";>Error : Invalid IP</p><</h2></center></body></html>');
	}
} else {
...
echo ('	<center><h1><p style="color:#FF0000";>Ip Information:</body></h1></center>
	<table align="center">
