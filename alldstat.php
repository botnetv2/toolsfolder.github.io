...
<head>
    ...
    <link rel="icon" type="img/png" sizes="16x16" href="img/red-folder.ico">
	 ...
	 <html lang="en">
      ...
      <meta name="Keywords" content="Tools, stresser, port scanner,psn resolver">
...
<a href="dstatlayer4.php"<button type="button" class="btn btn-default">LAYER 4 (NORMAL)</button></a>
<a href="dstatlayer7.php" <button type="button" class="btn btn-default">LAYER 7 (BAXET)</button></a>
<a href="/tools.php" <button type="button" class="btn btn-default"></button>BACK TO TOOLS</button></a>
                       <br/><br/>
