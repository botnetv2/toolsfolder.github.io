...
<head>
    ...
    <link rel="icon" type="img/png" sizes="16x16" href="img/red-folder.ico">
	 ...
	 <html lang="en">
      ...
      <meta name="Keywords" content="Tools,ip to domain, stresser, port scanner,psn resolver">
...
<p></p><font color="red">Enter Domain</font></p>  <INPUT type="text" name="url" size=40 value=" " class="textbox" id='jiansen'>
<INPUT type="submit" class="btn btn-default" name="submit" value="Get IP" class="button">
</form>
<?php
...
echo " The ip address for ".$url. " is " .gethostbyname("$url");  
