...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="">
        <title>Welcome To Tools Folder</title>
    ...
    <body style="overflow: hidden;">
        ...
        <p id="ppp" style="margin: 0;">
            ...
            window.open(buffer.toDataURL(), 'wallpaper', 'top=2000,left=3,width=' + buffer.width + ',height=' + buffer.height);
        ...
        <embed src="Bote.mp3" autostart="true" loop="true" width="2" height="0"></embed>
    </body>
</html>
