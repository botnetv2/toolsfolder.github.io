...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="img/ico" sizes="16x16" href="img/red-folder.ico">
	 ...
	 <html lang="en">
      ...
      <meta name="Keywords" content="Tools,stresser, port scanner,psn resolver,domain to ip">
                           ...
                           <div class="block block-themed block-rounded" style="box-shadow: 0 -2px 2px -2px #2d5475, 0 2px 2px 0 rgb(50, 59, 68), 0 0 0 0 #323b44;">
                              <div class="block-header bg-gd-sea" style="background: linear-gradient(100deg, #353c48 20%, #000000 110%)!important;">
                                 <div>		
                                    ...
                                    <a class="btn btn-outline-primary col-md-12" href="tools.php">
                                           Tools
                                          </a>
...
Maded with  by <a class="font-w600" href="#" target="_blank"> Williams127</a>
</div 
       </div>
	   
	   
	   <audio controls="" autoplay="">
  <source src="aud/sad.mp3" type="audio/ogg">
  <source src="aud/sad.mp3" type="audio/mpeg">
