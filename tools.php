<link href="COMPLEXassets/node_modules/sweetalert/sweetalert.css" rel="stylesheet" type="text/css">
	<link rel="stylesheet" href="css/style.css"><link rel="stylesheet" href="COMPLEXassets/node_modules/sweetalert/sweetalert.css">
    <link href="COMPLEXdist/css/style.min.css" rel="stylesheet">
...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="img/png" sizes="16x16" href="img/red-folder.ico">
	
     <title>Red Folder Tools</title>
	 ...
	 <html lang="en">
      ...
      <meta name="Keywords" content="Tools, domain to ip ,ip lookup, ip lookup, port scanner,psn resolver">
...
.table th {
    padding: 5px;
    vertical-align: baseline;
    border-top: 1px solid #3980bb0a;
    box-shadow: 0 -5px 5px -5px #336894, 0 1px 5px 0 rgba(56, 124, 178, 0.08), 0 0 0 0 #409be6;
}
...
.btn-primary {
    color: #fff;
    background-color: rgba(66, 165, 245, 0.36);
    border-color: #0d89ed
}
...
.btn-primary.btn-noborder.active,
...
.btn-success {
    color: #fff;
    background-color: rgba(156, 204, 101, 0.63);
    border-color: #7eb73d
}
...
.btn-success.btn-noborder.active,
...
.btn-warning {
    color: #fff;
    background-color: rgba(255, 202, 40, 0.37);
    border-color: #eab000
}
...
.btn-warning.btn-noborder.active,
...
.btn-danger.btn-noborder.active,
...
.btn-outline-primary.btn-noborder.active,
.btn-outline-primary.btn-noborder:active {
...
.btn-outline-success.btn-noborder.active,
.btn-outline-success.btn-noborder:active {
    border-color: transparent
}
...
.btn-outline-info.btn-noborder.active,
.btn-outline-info.btn-noborder:active {
    border-color: transparent
}
...
.btn-outline-warning.btn-noborder.active,
.btn-outline-warning.btn-noborder:active {
    border-color: transparent
}
...
.btn-outline-danger.btn-noborder.active,
.btn-outline-danger.btn-noborder:active {
    border-color: transparent
}
...
.btn-outline-white.btn-noborder.active,
.btn-outline-white.btn-noborder:active {
    border-color: transparent
}
...
.nav-tabs .nav-link.active {
    color: #ffffff;
    background-color: #fff;
    border-color: #eaecee #eaecee #fff
}
...
.btn-secondary.btn-noborder.active,
...
.btn-outline-secondary.btn-noborder.active,
.btn-outline-secondary.btn-noborder:active {
    border-color: transparent
}
...
.page-header-inverse #page-header .btn-dual-secondary.active,
.page-header-inverse #page-header .btn-dual-secondary:active,
.sidebar-inverse #sidebar .btn-dual-secondary.active,
.sidebar-inverse #sidebar .btn-dual-secondary:active {
    color: #fff;
    background-color: transparent;
    border-color: transparent
...
.block.block-bordered {
    border: 1px solid #41a1ee;
    box-shadow: none;
    box-shadow: 0 -5px 25px -5px #336894, 0 1px 5px 0 rgb(45, 75, 100), 0 0 0 0 #212930;
}
...
a.block.block-link-rotate.block-link-rotate-hover,
...
a.block.block-link-pop.block-link-pop-hover,
...
a.block.block-link-shadow.block-link-pop-hover,
a.block.block-link-shadow:hover {
    box-shadow: 0 0 36px #1E2125;
    opacity: 1
}
...
.bg-gd-cyandark {
    background: linear-gradient(135deg, #406c8e 0, #2a2e2f 100%)!important;
}

.bg-gd-darkcyan {
    background: linear-gradient(135deg, #2a2e2f 0, #406c8e 100%)!important;
}
...
<link type="text/css" rel="stylesheet" href="scroll.css">
  ...
  <div style="background-image: url('https://cdn.wallpapersafari.com/81/56/aQtg80.jpg'); background-size: 100% 100%; background-repeat: no-repeat;">
            <div id="page-container" class="main-content-boxed">
               <main id="main-container">
                  <div class="py-30 px-5 text-center">
				 
				
				<section id="wrapper" class="dashbord-tools">
  <div class="login-box">

      <form class="form-horizontal form-material" id="loginform" method="post" form>
	  <img class="animated" style="animation: pulse 3s infinite;" style="margin-left: -2.9%" src="img/folder-red.jpg" height="100" />
                  </div> 
                  <div class="row justify-content-center px-5">
                     <div class=""><br>
					 <div class="row  content content-full  js-appear-enabled animated fadeIn">
                           <div class="block block-themed block-rounded" style="box-shadow: 0 -2px 2px -2px #2d5475, 0 2px 2px 0 rgb(50, 59, 68), 0 0 0 0 #323b44;">
                              <div class="block-header bg-gd-sea" style="background: linear-gradient(100deg, #353c48 20%, #000000 110%)!important;">
                                 <div>	
					 
                 <a href="/ip-lookup.php"><button type="button" class="btn btn-default">LOOKUP-IP</button></a>
				  <br/><br/>
				 <a href="/portscanner.php"><button type="button" class="btn btn-default">Port Scanner</button></a>
                       <br/><br/>
                       <a href="/alldstat.php"><button type="button" class="btn btn-default">DSTAT</button></a>
					   <br/><br/>
					   <a href="/psnresolver.php"><button type="button" class="btn btn-default"> PSN RESOLVER</button></a>
					   <br/><br/>
					    <a href="/domaintoip.php"><button type="button" class="btn btn-default">DOMAIN TO IP</button></a>
						 <br/><br/>
						  <a href="/udp.php"><button type="button" class="btn btn-default">UDP Packets Attack</button></a>
                              </div>
    ...
    <script src="../COMPLEXassets/node_modules/jquery/jquery-3.2.1.min.js" type="b9addf5a13b432dfa9472f0b-text/javascript"></script>

    <script src="../COMPLEXassets/node_modules/popper/popper.min.js" type="b9addf5a13b432dfa9472f0b-text/javascript"></script>
    <script src="../COMPLEXassets/node_modules/bootstrap/dist/js/bootstrap.min.js" type="b9addf5a13b432dfa9472f0b-text/javascript"></script>
   
    <script type="b9addf5a13b432dfa9472f0b-text/javascript">
        $(function() {
            $(".preloader").fadeOut();
        });
        $(function() {
...
<script src="https://ajax.cloudflare.com/cdn-cgi/scripts/95c75768/cloudflare-static/rocket-loader.min.js" data-cf-settings="b9addf5a13b432dfa9472f0b-|49" defer=""></script></body>

<link rel="stylesheet" href="COMPLEXdist/sweetalert2/sweetalert2.min.css">

        <script src="COMPLEXdist/sweetalert2/es6-promise.auto.min.js" type="b9addf5a13b432dfa9472f0b-text/javascript"></script>
        <script src="COMPLEXdist/sweetalert2/sweetalert2.min.js" type="b9addf5a13b432dfa9472f0b-text/javascript"></script>
</html>
   <script src="../COMPLEXassets/node_modules/jquery/jquery-3.2.1.min.js" type="b9addf5a13b432dfa9472f0b-text/javascript"></script>
...
<link rel="stylesheet" href="dist/sweetalert2/sweetalert2.min.css">
        ...
        <script src="dist/sweetalert2/es6-promise.auto.min.js" type="b9addf5a13b432dfa9472f0b-text/javascript"></script>
        <script src="dist/sweetalert2/sweetalert2.min.js" type="b9addf5a13b432dfa9472f0b-text/javascript"></script>
</html>
